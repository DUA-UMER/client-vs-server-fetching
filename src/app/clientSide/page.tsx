        ...
        <div>
            ...
            {loading ? (
                ...
                <div className="py-[50px] px-[20px] sm:px-[30px] md:px-[40px] lg:px-[50px]">
                    <h1 className="mb-[40px] text-center text-[20px] sm:text-[28px] md:text-[30px] font-[700] text-[#8db4a8]">CLIENT SIDE DATA FETCHING</h1>
                    <div className="grid gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
                        {data.map((products, index) => (
                            <div key={index} className="w-full bg-[white] shadow-lg p-[20px] rounded-[8px] hover:shadow-xl hover:scale-[1.05] transition-all">
                                ...
                                <p className="text-[orange] text-[18px] flex items-center mb-[10px]"><IoIosStar  /><span className="mr-[5px]">{products.rating.rate}</span>({products.rating.count} reviews)</p>
                                <div className="flex items-center justify-end">
                                 <button className="py-[7px] px-[12px] bg-[#8db4a8] text-[white] rounded-[30px] hover:bg-[darkgreen] text-[17px]">Buy Now</button>
                                </div>
                            </div>
                        ))}
                    </div>
